...
def survivorSelection(population, number_of_population):
    ...
    for i in range(number_of_population):
        ...
        random_number1 = np.random.randint(0,len(population))
        random_number2 = np.random.randint(0,len(population))
        random_number3 = np.random.randint(0,len(population))
        random_number4 = np.random.randint(0,len(population))
        if (population[random_number1].fitness <= population[random_number2].fitness):
            if (population[random_number3].fitness <= population[random_number4].fitness):
                if (population[random_number1].fitness <= population[random_number3].fitness):
                    new_population.append(population[random_number1])
                else:
                    new_population.append(population[random_number3])
            else:
                if (population[random_number1].fitness <= population[random_number4].fitness):
                    new_population.append(population[random_number1])
                else:
                    new_population.append(population[random_number4])
        else:
            if (population[random_number3].fitness <= population[random_number4].fitness):
                if (population[random_number2].fitness <= population[random_number3].fitness):
                    new_population.append(population[random_number2])
                else:
                    new_population.append(population[random_number3])
            else:
                if (population[random_number2].fitness <= population[random_number4].fitness):
                    new_population.append(population[random_number2])
                else:
                    new_population.append(population[random_number4])
