...
low_use = pd.read_excel('C:/Users/mahdi/Desktop/pyton project/kar amoozi/inputData.xlsx')

#max available data
numtotal_periods = 48
# last 
last_month = str(max(low_use['NUM_MONTH_USE_SPMUS']))
...
pivot_table = low_use.pivot_table(values = 'QTY_NET_USE_SPMUS' , index = 'ITEM_ITEM_ID' , columns = 'NUM_MONTH_USE_SPMUS' , 
...
final_table.to_excel("output_low.xlsx",sheet_name="output")